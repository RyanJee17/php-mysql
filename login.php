...
if (isset($_POST['email']) && isset($_POST['password'])) {
    foreach ($users as $user) {
        if ($user['email'] === $_POST['email'] && $user['password'] === $_POST['password']) {
            ...
            // Sortir de la boucle une fois qu'un utilisateur est trouvé
        } else {
...
?>
<!-- Affichage du formulaire si l'utilisateur n'est pas identifié -->
<?php if (!isset($loggedUser)) : ?>
    ...
    <!-- Affichage du message de succès si l'utilisateur est identifié -->
<?php else : ?>
